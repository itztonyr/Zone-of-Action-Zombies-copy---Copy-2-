...
public class MFPSGeneralDoc : TutorialWizard
{
    ...
    new() { Name = "Addons", StepsLenght = 0, DrawFunctionName = nameof(DrawAddonsDoc) },
    ...
    void DrawAddonsDoc()
    {
        ...
        DrawNote("Due to Asset Store guidelines, we are not allowed to list the links to the addons directly, but you can find all the available addons in our website <b>lovattostudio.com</b>");
