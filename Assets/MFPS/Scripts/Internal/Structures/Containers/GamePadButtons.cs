namespace MFPS.InputManager
{
    ...
    public static class GamePadButtonsNames
    {
        ...
        public static readonly Dictionary<string, string> OverrideAxisNames = new Dictionary<string, string>() { { "DPV1", "D-Pad Up" }, { "DPV-1", "D-Pad Down" }, { "DPH1", "D-Pad Right" }, { "DPH-1", "D-Pad Left" } };
