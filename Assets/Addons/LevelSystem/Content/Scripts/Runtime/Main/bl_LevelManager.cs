...
public class bl_LevelManager : ScriptableObject
{
    ...
    /// THIS IS NOT THE LEVEL NUMBER, IS THE INDEX IN THE LIST
    /// </summary>
    /// <returns></returns>
    ...
    public LevelInfo GetLevel()
    {
        ...
        int levelID = GetLevelID(GetSavedScore());
        return Levels[levelID];
    }
    ...
    public LevelInfo GetPlayerLevelInfo(Player player)
    {
        ...
        if (player.CustomProperties.ContainsKey(PropertiesKeys.PlayerTotalScore))
            score = (int)player.CustomProperties[PropertiesKeys.PlayerTotalScore];
    ...
    /// <summary>
    /// Return the level index of the local player
    /// Not the actual level number but < 1
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Get the local Player level number
    /// </summary>
    /// <returns></returns>
    ...
    /// </summary>
    /// <returns></returns>
    public int GetLevelNumber(int score)
    {
        return GetLevelID(score) + 1;
    }
