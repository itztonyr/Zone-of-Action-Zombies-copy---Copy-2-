...
namespace MFPS.Addon.Customizer
{
    public class bl_AttachmentsButtons : MonoBehaviour
    {
        ...
        public void Init(bl_Customizer customizer)
        {
            ...
            {
                bl_CanvasAttachmentButtonManager.Instance.Setup(customizer, this);
                bl_CanvasAttachmentButtonManager.Instance.SetActiveAll(false);
                Active(false);
        ...
        public void Active(bool active)
        {
            if (bl_Input.IsGamePad)
            {
                bl_CanvasAttachmentButtonManager.Instance.SetActiveAll(active);
                return;
            }
            if (Barrel != null)
